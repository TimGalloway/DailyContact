...
namespace DailyContact
{
    ...
    public class MainActivity : Activity, ILocationListener
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            sendSMS.Click += delegate
            {
                var phoneNumbersText = FindViewById<TextView>(Resource.Id.txtPhoneNumbers);
                var situationRB = FindViewById<RadioGroup>(Resource.Id.radioGroup1);
                var situationButton = FindViewById<RadioButton>(situationRB.CheckedRadioButtonId);

                // fetch the Sms Manager
                SmsManager sms = SmsManager.Default;

                string strSMS = "Current Lat/Long: " + this.currentLocation.Latitude.ToString() + " / " + this.currentLocation.Longitude.ToString() +
                                    "\r\n\r\nLocation: " + this.addressText.Text +
                                    "\r\n\r\nSituation: " + situationButton.Text;
